...
- [ ] **Step 2: 实现 Sidecar historical read model**
...
- [ ] **Step 7: 同步操作手册、task-baseline 并提交**
...
| P6-03 | 真实 Run API 与 Web 展示 | current | P6-02 | 是 | historical Run/Attention/Artifact/Gate/Agent UI |
| P6-04 | RunDraft API 与 Web | planned | P6-01 | 是 | 草案、Dry-run、确认、审计 |
| P6-05 | Adapter Contract Schema 与注册表 | planned | P6-01 | 是 | invocation/result/receipt schema、real manifest |
| P6-06 | Codex CLI Health 与 Attempt Workspace | planned | P6-05 | 是 | health、隔离 workspace、进程控制 |
...
`P6-02 Historical Importer 与 Projection` 已完成，交付见 `48`。下一步主线是
`P6-03` 真实 Run API 与 Web 展示；`P6-04` 与 `P6-05` 可按共享文件冲突规则并行启动。
