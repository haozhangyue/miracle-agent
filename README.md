...
Codex CLI Adapter。`P6-01` 工程实施计划和 `P6-02` Historical Importer 与 Projection
已完成；当前主线进入 `P6-03` 真实 Run API 与 Web 展示，`P6-04` RunDraft 和 `P6-05`
Adapter Contract 可继续按三轨边界并行推进。
