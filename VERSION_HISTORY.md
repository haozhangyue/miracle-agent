...
**目标版本：** `v0.6.0`
**相对基线：** `1bd740f`
**当前文件变化：** 新增 1，更新 3，删除 0。

### 变更摘要

- 新增 P2 第一版产品信息架构与设计图规划。
- 明确控制中心、Run、Workflow、Agent、Artifact、Gate、Registry 和 Evolution 的
  页面归属。
- 明确 10 个 P0 Pencil 页面、10 条关键交互流程和低保真原型验收标准。
- README 和路线图同步进入 P2 原型阶段。
