...
`57_P7-07模型Provider接入交付说明.md` 是 P7-07 的当前交付说明。
当前 `P7-02` 至 `P7-07` 已完成；P7-05 已覆盖显式 failed 错误分类、fixed/exponential
...
真实 smoke 未执行，状态仍为 `configured_unverified`。`P7-08` 为当前 Provider fallback 与灵活路由任务。
...
实现时优先读取 55、56、57，再按任务回读对应 P6 交付文档。
...
flowchart TD
  ...
  P702 --> P707["57 P7-07 Provider 接入<br/>CURRENT"]
  P707 --> P708["P7-08 Fallback/路由<br/>CURRENT"]
```
...
| `56_P7工程实施计划与任务拆解.md` | `ACTIVE` | 55、54、51-53、Core、Sidecar、Web | 57、P7-08 至 P7-10 工程提交 | P7 当前逐文件 TDD 实施计划、依赖、提交点和验收命令必读 |
| `57_P7-07模型Provider接入交付说明.md` | `CURRENT` | 55、56、Core、Sidecar、Provider Profile | P7-08 Provider Router/fallback | P7-07 工程接入、凭证状态、fake-server 验收、真实 smoke 未执行和安全边界必读 |
