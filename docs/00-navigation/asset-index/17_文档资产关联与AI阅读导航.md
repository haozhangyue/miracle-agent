...
`55_P7多节点真实执行与模型Adapter扩展总体设计.md` 是当前 `P7-01` 设计评审真相源。
它确立 Codex 多节点纵向闭环优先、retry/fallback 后置、DeepSeek/Kimi/MiniMax
通过通用 Model API Adapter 接入，以及 P7 不接 OpenAI 官方 API 的边界。在它完成
人工评审前，AI 不应直接进入 P7-02 代码实施。
...
| `55_P7多节点真实执行与模型Adapter扩展总体设计.md` | `CURRENT` | 54、01、03、14、45、51-53 | P7-02 至 P7-10 | P7 纵向闭环、retry/fallback、模型 API 分层和评审门必读 |
