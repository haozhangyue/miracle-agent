...
flowchart TD
  ...
  P707 --> P708["58 P7-08 Fallback/路由<br/>CURRENT"]
  P708 --> P709["P7-09 UI/可观测<br/>CURRENT"]
```
...
| `56_P7工程实施计划与任务拆解.md` | `ACTIVE` | 55、54、51-53、Core、Sidecar、Web | 57-58、P7-09 至 P7-10 工程提交 | P7 当前逐文件 TDD 实施计划、依赖、提交点和验收命令必读 |
...
| `58_P7-08Provider路由与Fallback交付说明.md` | `CURRENT` | 55-57、Core、Sidecar、Retry | P7-09 UI/可观测 | Provider Router、fallback、人工确认、路由审计和健康边界必读 |
