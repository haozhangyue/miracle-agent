...
`00_Miracle角色化说明书与Web帮助中心设计.md` 是已确认的下一版说明书体系设计基线，
定义使用者、管理员、开发维护者三份角色手册、公共故障与版本变化手册，以及 Web
帮助中心读取同源 Markdown 的安全边界。在 `61-65` 和 Web 帮助入口完成验收前，AI
仍以 `40` 作为当前操作真相，不得把设计稿中尚未实现的 Help API 或菜单描述为已上线。
