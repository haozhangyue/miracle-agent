...
`58_P7-08Provider路由与Fallback交付说明.md` 是当前路由交付说明。
当前 `P7-02` 至 `P7-08` 已完成；P7-05 已覆盖显式 failed 错误分类、fixed/exponential
...
跨 kind 人工确认和 Run 级审计；`P7-09` 为当前多运行时 UI 与可观测性任务。
...
实现时优先读取 55、56、58；维护 Provider Driver 时再读 57，并按任务回读对应 P6 交付文档。
