...
`47_P6真实工作流工程实施计划与任务拆解.md` 是当前 P6 工程实施真相源。执行
historical importer、真实 Run UI、RunDraft、Adapter Contract 或 Codex CLI 任务时，先读
`47`，再按其中列出的 P5 输入文档和精确文件边界补读。`48-53` 记录 P6-02 至 P6-07
已实现结果，当前主线任务为 `P6-08` 回归验收与版本收口。
...
flowchart TD
  ...
  P603 --> P604["P6-04 RunDraft API/Web<br/>CURRENT TASK"]
  P603 --> P605["P6-05 Adapter Contract<br/>PARALLEL"]
```
...
| `47_P6真实工作流工程实施计划与任务拆解.md` | `CURRENT` | 39、43-46、packages/core、apps/sidecar、apps/web | P6-02 至 P6-08 工程实现 | P6 实现任务必读 |
| `48_P6-02HistoricalImporter与Projection交付说明.md` | `CURRENT` | 39、47、packages/core、apps/sidecar、真实 W24/W23 | P6-03 真实 Run API/UI | P6-03 前必读 |
| `49_P6-03真实Run_API与Web展示交付说明.md` | `CURRENT` | 47、48、apps/sidecar、apps/web、assets/reviews/p6-real-run-ui | P6-04 RunDraft API/Web | P6-04 前必读；记录 P6-03 完成结果 |
| `50_P6-04RunDraft_API与Web交付说明.md` | `CURRENT` | 44、47、Core、Sidecar、Web | P6-07 统一启动事务 | RunDraft 操作与审计真相源 |
| `51_P6-05AdapterContract与注册表交付说明.md` | `CURRENT` | 45、47、Core、Sidecar | P6-06 Codex CLI runtime | Adapter 契约真相源 |
| `52_P6-06CodexCLI健康检查与工作区交付说明.md` | `CURRENT` | 45、47、51、Sidecar | P6-07 单节点真实执行 | Health、workspace 与进程控制真相源 |
| `53_P6-07Codex单节点真实执行交付说明.md` | `CURRENT` | 47、50-52、Core、Sidecar、Web | P6-08 回归验收与版本收口 | 真实单节点执行、Artifact/Gate/Trace 与用户操作必读 |
